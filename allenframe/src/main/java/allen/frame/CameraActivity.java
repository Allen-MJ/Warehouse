...
import allen.frame.tools.ICameraControl;
import allen.frame.tools.PermissionCallback;
import allen.frame.widget.CameraView;
import allen.frame.widget.CropView;
import allen.frame.widget.FrameOverlayView;
import allen.frame.widget.MaskView;
...
public class CameraActivity extends AllenBaseActivity {
