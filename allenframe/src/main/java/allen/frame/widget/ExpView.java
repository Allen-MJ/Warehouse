...
public class ExpView extends View {
    ...
    public ExpView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.PercentRectangleView);
        ...
        mTotalColor = mTypedArray.getColor(R.styleable.PercentRectangleView_totalColor, mTotalColor);
        mTotalTextColor = mTypedArray.getColor(R.styleable.PercentRectangleView_totalTextColor, mTotalTextColor);
        ...
        mUsedColor = mTypedArray.getColor(R.styleable.PercentRectangleView_usedColor, mUsedColor);
        mUsedTextColor = mTypedArray.getColor(R.styleable.PercentRectangleView_usedTextColor, mUsedTextColor);
        ...
        mStrokeColor = mTypedArray.getColor(R.styleable.PercentRectangleView_strokeColor, mStrokeColor);
        mStrokeWidth = mTypedArray.getDimension(R.styleable.PercentRectangleView_strokeWidth,mStrokeWidth);
        mStrokeRadius = mTypedArray.getDimension(R.styleable.PercentRectangleView_strokeRadius,mStrokeRadius);
    ...
    /**设置总容量的颜色*/
    public ExpView setTotalColor(int color) {
        mTotalColor = color;
        mTotalPaint.setColor(mTotalColor);
        return this;
    }
    ...
    /**设置已使用容量的颜色*/
    public ExpView setUsedColor(int color) {
        mUsedColor = color;
        mUsedPaint.setColor(mUsedColor);
        return this;
    }
    ...
    /**设置已使用容量的字体颜色*/
    public ExpView setUsedTextColor(int color) {
        mUsedTextColor = color;
        return this;
    }

    /**设置总容量的字体颜色*/
    public ExpView setTotalTextColor(int color) {
        mTotalTextColor = color;
        return this;
    }

    /**设置总容量的字体颜色*/
    public ExpView setStrokeColor(int color) {
        mTotalPaint.setColor(color);
        return this;
    }

    /**设置进度条边框  以及圆角*/
    public ExpView setStroke(float width, float radius) {
        mStrokeWidth = width;
    ...
    /**更新当前进度*/
    public ExpView setPercent(float percent) {
        mPercent = percent;
        return this;
    }

    /**进度内容显示*/
    public ExpView setTips(CharSequence tips) {
        mTips = tips;
        mTipArr = null;
        return this;
    }
    /**进度内容显示   区分显示*/
    public ExpView setTipArray(@NonNull CharSequence used, @NonNull CharSequence total) {
        if (mTipArr==null){
    ...
    /**字体大小占空间高度的百分比 */
    public ExpView setTestSizePercent(float sizePercent) {
